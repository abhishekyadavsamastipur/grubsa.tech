        ...
        <div className='bg-[#2699fb] p-4'>
           <div className='max-w-[1240px] md:flex mx-auto justify-between py-[40px]'>
                <div className='m-2' >
                    ...
                    <span className='text-white'>Sign up to our course and stay up to date.</span>
                </div>
                <div className='m-2'>
                   ...
                   <p className='text-white'>
                    We care bout the protection lof your data. Read our <br/> <a href='/' className='text-black'> Privacy Policy.</a>
                   </p>
